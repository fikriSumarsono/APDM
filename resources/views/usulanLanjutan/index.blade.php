...
<div class="card-header bg-secondary" >
    ...
    <div class="card-body">
        <div class="col-md-12">
            ...
            @foreach($researchs as $data)
                ...
                <tr>
                <td ></td>
                <td align="center"><a href="file/penelitian/Laporan Akhir/{{$data->laporan_akhir}}" download="{{$data->laporan_akhir}}">(link download)</a></td>
    ...
    <div class="modal" id="modalLanjutan{{ $data->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <form method ="post" action ="/lanjutans" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control " id="usulan" name="usulan" value="penelitian" readonly>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <strong class="text-danger"><h6>*Max size file 5mb</h6> </strong>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
