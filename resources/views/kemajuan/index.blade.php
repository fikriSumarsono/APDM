...
<div class="card-header bg-secondary" >
    ...
    <div class="card-body">
        <div class="col-md-6">
        <form method ="post" action ="/KirimKemajuan" enctype="multipart/form-data">
        @csrf
    ...
    <div class="card-header bg-secondary">
        <div class="row">
            <div class="col-md-6" >
                <h6 style="font-weight: bold;">Laporan Kemajuan Penelitian ~ Loog Book </h6>
            </div>
        </div>                     
    </div>
    <div class="card-body">
    ...
    <div class="card-header bg-secondary">
        <div class="row">
            <div class="col-md-6" >
                <h6 style="font-weight: bold;">Dokumen Kemajuan Penelitian</h6>
            </div>
        </div>                     
    </div>
    <div class="card-body">
