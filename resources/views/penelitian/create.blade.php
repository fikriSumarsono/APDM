...
<div class="card-header bg-secondary" >
    <div class="row">
        <div class="col-md-3">
            <h6 style="font-weight: bold;">Rincian Penelitian</h6>
        </div>
    </div>
</div>                     
    <div class="card-body">
        <div class="col-md-3">
            <form method ="post" action ="/researchs" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tahun" placeholder="Tahun Penelitian" name="tahun" >
                </div> 
        </div>
    </div>
