      ...
      <nav class="mt-2">
        ...
        ith font-awesome or any other icon font library -->
          <li class="nav-item has-treeview menu-open">
            <a href="{{route('KetuaProdi')}}" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/PengusulanPenelitian')}}" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/PengusulanPengabdian')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengabdian</p>
                </a>              </li>
              </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/Kpenelitian')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penelitian</p>
                </a>              </li>
              </ul>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/Kpengabdian')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengabdian</p>
                </a>              </li>
              </ul>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/Apenelitian')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penelitian</p>
                </a>              </li>
              </ul>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/Apengabdian')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengabdian</p>
                </a>              </li>
              </ul>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/PenelitianLanjutan')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penelitian</p>
                </a>              </li>
              </ul>
